...
class Upcoming extends StatefulWidget{
  ...
  @override
  State<Upcoming> createState()=> _MyWidgetState();
}

class _MyWidgetState extends State<Upcoming>{
  List<dynamic> movies = [];
  bool isLoading = true;
  ...
  Future<void> fetchWeeklyPopularMovies() async {
    try {
      final response = await http.get(
        Uri.parse('https://api.themoviedb.org/3/movie/upcoming?api_key=549c475ef82621dc249692526f2ff2cd'),
      );
